  ...
  ({ children, variant = "secondary", size = "md", ...props }, ref) => {
    ...
    return (
        <button
            ref={ref}
            className={cn(
              'inline-flex items-center justify-center font-medium font-sans cursor-pointer transition-colors disabled:cursor-not-allowed disabled:opacity-50 select-none',
